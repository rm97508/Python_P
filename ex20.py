...
# programa deverá calcular e exibir quanto o aluno precisa tirar na segunda nota minimamente (P2) para ser aprovado, 
# sabendo que a média de aprovação é igual a cinco.
p1 = float(input('Digite nota da P1: '))

p2 = (15-p1)/2

print(f'Você precisa tirar uma nota igual ou maior que {p2:.2f} para ser aprovado!')    
